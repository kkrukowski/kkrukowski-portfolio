...
const Navbar = () => {
    ...
    return (
        <>
            <nav className={"z-50 fixed w-full flex justify-center mobile:justify-end items-center h-[60px] sm:h-[80px] border-b-[2px] border-dark bg-light shadow-lg"}>
                {/* Desktop Menu */}
                ...
                <div className={`hidden mobile:flex w-full items-center justify-between px-4 sm:px-12 desktop:px-24`}>
                    <LogoLink />
                    <button
                        onClick={toggleMenu}
